...
## Las veintinueve salidas, y de qué archivo sale cada una
...
Las veintinueve de arriba son **productoras**: proyectan o emiten. Estas otras son
...
Y una regla de forma que vale para las veintinueve salidas: **si la salida se arma
...
7. Si el cambio agrega una **salida nueva** (un endpoint, un webhook, un log
   con contenido, un mail, un JSON más, **una página**), decilo fuerte: son **veintinueve**
...
2. **Tabla de campos tocados × las veintinueve salidas** (`sale` / `no sale` /
