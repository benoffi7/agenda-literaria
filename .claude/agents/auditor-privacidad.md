...
## Las veintitrés salidas, y de qué archivo sale cada una
...
Las veintitrés de arriba son **productoras**: proyectan o emiten. Estas otras son
...
Y una regla de forma que vale para las veintitrés salidas: **si la salida se arma
...
7. Si el cambio agrega una **salida nueva** (un endpoint, un webhook, un log
   con contenido, un mail, un JSON más, **una página**), decilo fuerte: son **veintitrés**
   hoy y una vigesimocuarta cambia el mapa y la doc — esta tabla, la de
...
2. **Tabla de campos tocados × las veintitrés salidas** (`sale` / `no sale` /
