...
## Las veintiuna salidas, y de qué archivo sale cada una
...
Las veintiuna de arriba son **productoras**: proyectan o emiten. Estas otras son
...
Y una regla de forma que vale para las veintiuna salidas: **si la salida se arma
...
7. Si el cambio agrega una **salida nueva** (un endpoint, un webhook, un log
   con contenido, un mail, un JSON más, **una página**), decilo fuerte: son **veintiuna**
...
2. **Tabla de campos tocados × las veintiuna salidas** (`sale` / `no sale` /
