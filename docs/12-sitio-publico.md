...
| `/guia/lugares` | El directorio de lugares para eventos: todas las fichas publicadas en el HTML, más una island con los cinco filtros del § 7 del PRD 4 —capacidad en rangos, costo en tres clases, barrio, qué incluye y tipo—. Con esto la Guía queda completa: ninguna fila dice ya «en camino». **No estaba en este diseño** — B-833 | Build. La island baja `/lugares.json` |
