...
| `/guia/librerias/{slug}` | La ficha de una librería: dirección, provincia y barrio o ciudad (B-967), los cuatro contactos, la galería completa y el `BookStore`. **Cero JavaScript**, como el detalle — B-901 | Build (`caminosDeDirectorio('librerias')`) |
