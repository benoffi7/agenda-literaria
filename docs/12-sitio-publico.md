...
| `/guia` | El índice de los tres directorios. **No estaba en este diseño** — B-835, decisión del dueño del 2026-09-08. Las filas salen de `DIRECTORIOS` (`src/lib/directorios.ts`); una sin página diría «en camino» y no linkearía, pero **las tres existen desde el 2026-09-11** | Build |
