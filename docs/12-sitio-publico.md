...
| `/guia/suscripciones/{slug}` | La ficha: qué incluye, qué manda, extras, alcance, **el precio con su fecha de carga al lado** y la acción que nombra a quién le estás comprando. **Cero JavaScript** — B-832 | Build (`caminosDeSuscripcion`) |
