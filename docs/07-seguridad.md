...
| 4 | La analítica del panel (GA4) | `src/lib/analytics-eventos.ts` | `tests/analytics-privacidad.test.ts` |
...
(B-124, D-350). **El alta no movió la cuenta.**
