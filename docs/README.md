...
| — | [`prd/`](prd/README.md) | **Lo que se está construyendo, especificado.** Cuatro PRDs del 2026-09-08 —el formulario público de propuestas (`/proponer`, construido) y los tres directorios: **librerías** con su listado y su ficha construidos y el alta pública todavía cerrada (B-872), suscripciones y lugares sin empezar— más el inventario archivo por archivo. Se lee antes de empezar a codear, no en vez del BACKLOG. |
