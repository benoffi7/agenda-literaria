...
| 17 | [`17-roadmap.md`](17-roadmap.md) | **El roadmap** relevado el 2026-09-24: 36 propuestas en seis ejes (sitio, panel, analítica, redes y correo, control de datos, otros), con tamaño, prioridad, qué ya existe y las decisiones del dueño con la pregunta escrita. Lo que se construya se anota en el BACKLOG; esto no es la lista de trabajo. |
