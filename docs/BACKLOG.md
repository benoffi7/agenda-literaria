...
| **B-500** | El aviso «ya-paso» reencuadrado: el dueño no entendía por qué el tablero marcaba como problema algo que es el archivo funcionando bien (D-270) | ✅ hecho (2026-09-03) — texto reescrito, movido al final de `CLASES_DE_AVISO`, filtro sin tocar |
