...
|---|---|---|---|
| 🔒 | `auditor-privacidad` | agente (solo lectura) | Que nada privado llegue a las treinta salidas públicas |
...
**Para qué.** El proyecto tiene **treinta salidas públicas** y una sola regla
...
tocados contra las treinta salidas, un bloque por hallazgo (severidad P0/P1/P2,
...
arranca obligando a decidir las treinta salidas **antes** de escribir código, que
