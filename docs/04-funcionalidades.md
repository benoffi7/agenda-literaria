...
| Opciones de los desplegables, estado del catálogo, propuestas, reportar algo, historial de una actividad, y los cuatro directorios de la Guía (librerías, suscripciones, lugares, bibliotecas) | No aparecen. Las cinco pantallas que sí ve están escritas una por una en `PERMISOS`: listado, calendario, y el formulario en sus tres formas |
